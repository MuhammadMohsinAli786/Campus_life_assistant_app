...
class DateAttendance {
  ...
  DateAttendance({required this.attendance, required this.date});
}

dynamic fetch(
    String url, String username, String password, String lnctu) async {
  try {
...
dynamic getdatewiseattendance(
    String username, String password, String lnctu) async {
