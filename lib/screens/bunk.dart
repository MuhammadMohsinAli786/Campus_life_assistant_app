...
class _BunkState extends State<Bunk> {
  ...
  late double present;
  late int lecturesNeeded;
  late int daysNeeded;
  late int freeDays;
  late String msg;
  late bool goalIsThere;
  bool isError = false;
  ...
  int findFreeDays({double? g, double? p, required double per, double? t}) {
    if (g! * 100 < per) {
      double x = (p! - g * t!) / g;
      msg =
        ...
        child: Scaffold(
            floatingActionButton: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor:
                    Colors.deepOrange[400], // Button background color
                shape: const CircleBorder(),
                padding: const EdgeInsets.all(
                    0), // Optional: adjust padding for better fit
              ),
              child: Container(
                height: 60,
                width: 60,
                ...
                child: const FaIcon(
                  ...
                  // color: Colors.white, // Uncomment if specific color is needed
                ),
              ),
            ),
          ...
          child: Column(
            children: <Widget>[
              ...
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      ThemeData.dark().buttonTheme.colorScheme?.primary,
                ),
                onPressed: () async {
                  showDialog(
                    context: context,
  ...
  Widget circle({required String text, required int id}) {
